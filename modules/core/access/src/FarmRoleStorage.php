...
class FarmRoleStorage extends RoleStorage {
   ...
   *
   * @var \Drupal\farm_access\ManagedRolePermissionsManagerInterface
   */
   ...
   * @param \Drupal\farm_access\ManagedRolePermissionsManagerInterface $managed_role_permissions_manager
