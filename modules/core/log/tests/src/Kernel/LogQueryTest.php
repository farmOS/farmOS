...
class LogQueryTest extends KernelTestBase {
  ...
  public function testLogQueryFactory() {
    ...
    $log_ids = $this->logQueryFactory->getQuery()->execute();
    ...
    $log_ids = $this->logQueryFactory->getQuery(['type' => 'foo'])->execute();
    ...
    $log_ids = $this->logQueryFactory->getQuery(['timestamp' => $now])->execute();
    ...
    $log_ids = $this->logQueryFactory->getQuery(['status' => 'pending'])->execute();
    ...
    $log_ids = $this->logQueryFactory->getQuery(['asset' => $asset])->execute();
    ...
    $log_ids = $this->logQueryFactory->getQuery(['limit' => 1])->execute();
